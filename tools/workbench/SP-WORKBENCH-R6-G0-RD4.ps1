...
if($null -ne $Errors -and @($Errors).Count -gt 0){
    ...
    throw "STOP: exact-final R6-G0 RD4 parser preflight failed."
}
...
Write-Host " EXACT RECOVERED SOURCE INTROSPECTION / NO GUESSED METHOD NAMES" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
...
Pass-R6 (-not (Test-Path -LiteralPath $OutputDir)) "fresh RD4 evidence lane absent"
...
[void]$Builder.AppendLine("SIGNALPROOF WORKBENCH GUI RD2 R6 - G0 RD4")
...
Pass-R6 (Test-Path -LiteralPath $ReportPath -PathType Leaf) "RD4 localization report written"
Pass-R6 (Test-Path -LiteralPath $JsonPath -PathType Leaf) "RD4 localization JSON written"
...
Write-Host " R6-G0 RD4 PASS / EXACT SOURCE LOCALIZED FOR G1" -ForegroundColor Green
Write-Host "======================================================================" -ForegroundColor Green
Write-Host ("REPORT   : "+$ReportPath)
Write-Host ("EVIDENCE : "+$JsonPath)
Write-Host ""
Write-Host "Paste the console output plus the report contents for immediate R6-G1 build." -ForegroundColor Yellow
