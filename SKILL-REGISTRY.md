...
| `signalproof-router` | 0.1.7-rc1 | Integration candidate | Active-skill selection plus Readiness, Verify, Review, Recovery, Security, Release, and Closeout routing | Candidate |
