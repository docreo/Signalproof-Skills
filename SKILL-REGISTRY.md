...
| `signalproof-router` | 0.1.10 | Active public baseline | Active-skill selection plus Research, Evaluate, Readiness, Verify, Review, Recovery, Security, Release, Document, and Closeout routing | Active |
