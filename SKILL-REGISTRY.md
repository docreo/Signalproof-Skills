...
| `signalproof-release` | 0.1.0-rc1 | Initial public release candidate | Exact-artifact release governance, evidence binding, provenance, rollback designation, release claims, and distribution authority | Candidate |
