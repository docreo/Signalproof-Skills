...
| `signalproof-router` | 0.1.8-rc1 | Research integration release candidate | Active-skill selection plus Research, Readiness, Verify, Review, Recovery, Security, Release, and Closeout routing | Candidate |
