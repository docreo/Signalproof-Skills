...
| `signalproof-print` | 0.2.0 | Active candidate update | Apply accepted Signalproof paper styling, create/verify authoritative DOCX, import DOCX to native Google Docs, optional PDF | Candidate |
