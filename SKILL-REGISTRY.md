...
| `signalproof-router` | 0.1.6-rc1 | Release-routing integration candidate | Active-skill selection plus Verify, Review, Recovery, Security, Release, and Closeout routing | Candidate |
