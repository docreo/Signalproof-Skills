...
| `signalproof-router` | 0.1.3-rc1 | Review integration candidate | Active-skill selection plus verification, Review, and meaningful-milestone closeout routing | Candidate |
