...
| `signalproof-router` | 0.1.7 | Active public baseline | Active-skill selection plus Readiness, Verify, Review, Recovery, Security, Release, and Closeout routing | Active |
