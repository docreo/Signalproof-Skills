...
| `signalproof-router` | 0.1.9-rc1 | Router Evaluate integration candidate | Active-skill selection plus Research, Evaluate, Readiness, Verify, Review, Recovery, Security, Release, and Closeout routing | Candidate |
