...
| `signalproof-router` | 0.1.4-rc1 | Recovery integration release candidate | Active-skill selection plus verification, Review, Recovery, and meaningful-milestone closeout routing | Candidate |
