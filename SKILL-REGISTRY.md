...
| `signalproof-router` | 0.1.2-rc1 | Verification-integration candidate | Active-skill selection plus evidence-verification and meaningful-milestone closeout routing | Candidate |
