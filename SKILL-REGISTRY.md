...
| `signalproof-router` | 0.1.10-rc1 | Document-routing integration candidate | Active-skill selection plus Research, Evaluate, Readiness, Verify, Review, Recovery, Security, Release, Document, and Closeout routing | Candidate |
