...
| `signalproof-router` | 0.1.8 | Active public baseline | Active-skill selection plus Research, Readiness, Verify, Review, Recovery, Security, Release, and Closeout routing | Active |
